...
"""
Replay Buffer class stores data that is collected from the enviornment
and is responsible for training the net. 
"""


class ReplayBuffers(object):

    # declares the maxlen of deque
    ...
    def add_data(self, state, action, reward, next_state, done):
        transition = (state, action.flatten(), reward, next_state, done)
